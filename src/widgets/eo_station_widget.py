...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(self.group_box_controls)
        self.groupBox_5.setObjectName("groupBox_5")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.groupBox_5)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.btnUp = QtWidgets.QPushButton(self.groupBox_5)
        self.btnUp.setObjectName("btnUp")
        self.verticalLayout_6.addWidget(self.btnUp)
        ...
        self.btnDown = QtWidgets.QPushButton(self.groupBox_5)
        self.btnDown.setObjectName("btnDown")
        self.verticalLayout_6.addWidget(self.btnDown)
        self.verticalLayout_2.addWidget(self.groupBox_5)
        self.groupBox_4 = QtWidgets.QGroupBox(self.group_box_controls)
        self.groupBox_4.setObjectName("groupBox_4")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.groupBox_4)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.lbl_zoom_status = QtWidgets.QLabel(self.groupBox_4)
        self.lbl_zoom_status.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_zoom_status.setObjectName("lbl_zoom_status")
        self.verticalLayout_7.addWidget(self.lbl_zoom_status)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.cmd_zoom_in = QtWidgets.QPushButton(self.groupBox_4)
        self.cmd_zoom_in.setObjectName("cmd_zoom_in")
        self.horizontalLayout_6.addWidget(self.cmd_zoom_in)
        self.cmd_zoom_out = QtWidgets.QPushButton(self.groupBox_4)
        self.cmd_zoom_out.setObjectName("cmd_zoom_out")
        self.horizontalLayout_6.addWidget(self.cmd_zoom_out)
        self.verticalLayout_7.addLayout(self.horizontalLayout_6)
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.cmd_zoom_in_repeated = QtWidgets.QPushButton(self.groupBox_4)
        self.cmd_zoom_in_repeated.setObjectName("cmd_zoom_in_repeated")
        self.horizontalLayout_9.addWidget(self.cmd_zoom_in_repeated)
        self.cmd_zoom_out_repeated = QtWidgets.QPushButton(self.groupBox_4)
        self.cmd_zoom_out_repeated.setObjectName("cmd_zoom_out_repeated")
        self.horizontalLayout_9.addWidget(self.cmd_zoom_out_repeated)
        self.verticalLayout_7.addLayout(self.horizontalLayout_9)
        self.horizontalLayout_10.addLayout(self.verticalLayout_7)
        self.verticalLayout_2.addWidget(self.groupBox_4)
        self.groupBox_2 = QtWidgets.QGroupBox(self.group_box_controls)
        ...
        self.lbl_mast_height = QtWidgets.QLabel(self.groupBox)
        self.lbl_mast_height.setObjectName("lbl_mast_height")
        self.horizontalLayout_5.addWidget(self.lbl_mast_height)
        ...
        self.progressMastHeight.setOrientation(QtCore.Qt.Horizontal)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_5.setTitle(_translate("Form", "Pan && Tilt Controls"))
        self.btnUp.setText(_translate("Form", "Up"))
        self.btnLeft.setText(_translate("Form", "Left"))
        self.btnRight.setText(_translate("Form", "Right"))
        self.btnDown.setText(_translate("Form", "Down"))
        self.groupBox_4.setTitle(_translate("Form", "Zoom Controls"))
        self.lbl_zoom_status.setText(_translate("Form", "1.0x"))
        self.cmd_zoom_in.setText(_translate("Form", "+"))
        self.cmd_zoom_out.setText(_translate("Form", "-"))
        self.cmd_zoom_in_repeated.setText(_translate("Form", "++"))
        self.cmd_zoom_out_repeated.setText(_translate("Form", "--"))
        ...
        self.lbl_mast_height.setText(_translate("Form", "0.0m"))
